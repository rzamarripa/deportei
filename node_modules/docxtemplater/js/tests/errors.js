...
describe("errors", function () {
	it("should be thrown when unclosedtag", function () {
		...
		var tags = {};
		var xmlTemplater = testUtils.createXmlTemplaterDocx(content, { tags: tags });
		var expectedError = {
			name: "TemplateError",
	...
	it("should fail when tag already opened", function () {
		...
		var xmlTemplater = testUtils.createXmlTemplaterDocx(content);
		var expectedError = {
			name: "TemplateError",
			message: "Unclosed tag",
			properties: {
	...
	describe("internal errors", function () {
		it("should fail", function () {
			...
			var test = {
				fn: function fn() {
					return testUtils.createXmlTemplaterDocx(1);
				}
			};
