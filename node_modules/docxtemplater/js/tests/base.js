...
describe("inspect module", function () {
	...
	doc.render();
	var postParsed = inspectModule.fullInspected["word/document.xml"].postparsed;
...
describe("intelligent tagging multiple tables", function () {
	it("should work with multiple rows", function () {
		...
		var doc = testUtils.createXmlTemplaterDocx(content, { tags: scope, intelligentTagging: true });
		doc.render();
...
describe("Complex table example", function () {
	...
	it("should work with two tables and intelligentTagging", function () {
		...
		var doc = testUtils.createXmlTemplaterDocx(template, { tags: tags, intelligentTagging: true });
		doc.render();
		var fullText = doc.getFullText();
