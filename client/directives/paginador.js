...
angular.module('insude').directive('bsTable', bsTable);
function bsTable () {
        return {
            restrict: "A",
            scope: true,
 ...
 angular.module('insude').directive('convertToNumber', convertToNumber);
 ...
 angular.module('insude').filter('bsTableSkip', bsTableSkip);
 function bsTableSkip () { 
